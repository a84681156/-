        ...
        <div class="writePageBox">
            ...
            <form action="" id="form">
                <table>
                    <tr>
                        <td colspan="6">
                        	<input type="hidden" class="formControl" name="jobs_post_no" value="${param.jobs_post_no }">
                        	<input type="hidden" class="formControl" name="jobs_reg_date" value="${param.jobs_reg_date }">
                        	<input type="hidden" class="formControl" name="jobs_cnt" value="${param.jobs_cnt }">
                        	<input type="hidden" class="formControl" name="jobs_recommend" value="${param.jobs_recommend }">
                            <label><i class="fa-solid fa-bars"></i> 제목</label>
                            <input type="text" class="formControl" name="jobs_title" value="${param.jobs_title }" placeholder="제목을 입력하세요.">
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        <td colspan="6">
                            ...
                            <textarea class="contentForm" name="jobs_content" id="writeContent" cols="30" rows="10" placeholder="내용을 입력하세요."><c:out value='${param.jobs_content }'/></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6"> 
    ...
    <script>
    	...
    	$(document).ready(function(){//제이쿼리를 실행하기 위한 준비
    		$("#modifyBtn").on("click", function(){
    			...
    			form.attr("action", "<c:url value='/jobs/modify?jobs_post_no=${jobs_post_no}'/>");
