...
<body>
    ...
    <div class="container">
        ...
        <div class="writePageBox">
            ...
            <form action="<c:url value='/crews/write'/>" method="post"  enctype="multipart/form-data">
                <table>
                    <tr>
                        <td colspan="4">
                            <label><i class="fa-solid fa-bars"></i> 제목</label>
                            <input type="text" class="formControl" name="crew_title" placeholder="제목을 입력하세요.">
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <textarea class="contentForm" name="crew_content" id="writeContent" cols="30" rows="10" placeholder="내용을 입력하세요."></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4"> 
                ...
                <div class="writeBtnBox">
                    <a><input type="submit" class="writeBtn" id="writeBtn" value="글쓰기"></a>
