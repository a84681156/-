...
<body>
    ...
    <div class="container">
        ...
        <div class="writePageBox">
            ...
            <form action="<c:url value='/qa/write'/>" method="post" >
                <table>
                    <tr>
                        <td colspan="5">
                            <label><i class="fa-solid fa-bars"></i> 제목</label>
                            <input type="text" class="formControl" name="qa_title" placeholder="제목을 입력하세요.">
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                ...
                <div class="writeBtnBox">
                    <a><input type="submit" class="writeBtn" id="writeBtn" value="확인"></a>
